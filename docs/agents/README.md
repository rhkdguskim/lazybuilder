...
|---|---|---|
| [quickstart.md](quickstart.md) | 30-second orientation for first-time invocation | A user just asked "use lazybuilder for X" |
...
| [harness-integration.md](harness-integration.md) | How LazyBuilder fits into an AI dev loop | Designing multi-step agent flows |
| [architecture.md](architecture.md) | Code map, layers, extension points, test harness | Modifying lazybuilder's source |

## Stability matrix

| Section | Stability | Notes |
|---|---|---|
| Schemas tagged `lazybuilder/v1` | **Stable** | Additive changes only. Breaking change ⇒ bump to `v2`. |
